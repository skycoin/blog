...
Команда Skycoin разработала новый алгоритм консенсуса, названный [Obelisk](https://www.skycoin.com/whitepapers),
который не требует "майнинга" (или другой его альтернативы типа [Proof-of-Stake](https://en.wikipedia.org/wiki/Proof-of-stake)).
Об этот рассказано в [whitepapers](https://www.skycoin.com/whitepapers).
