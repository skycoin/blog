...
title = "Skywire v1.2.1 Released"
+++

### Skywire v1.2.1

Skywire v1.2.1 has been released and is available from [GitHub](https://github.com/skycoin/skywire/releases/tag/v1.2.1).

This is a hotfix release addressing a login issue:

- **Login UI fix** — resolved an issue where the login UI was inaccessible for users
