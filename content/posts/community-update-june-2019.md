...
description = "Skycoin delivered massive announcements during the dubbed #MonthOfAnnouncements. Exchange listings, multiple wallet updates, CX chains and much more!"
image = "/img/june_community_update_blog_updates_2500x1774.png"
tags = ["Development", "Announcements"]
title = "June 2019 Community Update "
...
![CoinCodeCap.com Ranks Skycoin as Number 2](/img/CoinCodeCap.com Skycoin.jpg "CoinCodeCap.com Ranks Skycoin as Number 2")

Check out the [Development Recap](https://medium.com/skyfleet-captains-log/skycoin-development-recap-june-2019-e6447cfcb5ed) or full development articles can be found here:
[Wallet Update](https://www.skycoin.com/blog/posts/major-june-announcements/) | [CX 0.7.0](https://www.skycoin.com/blog/posts/introducing-cx-v0-7/) | [Week 23](https://www.skycoin.com/blog/posts/skycoin-development-update-week-22/)| [Week 24](https://www.skycoin.com/blog/posts/skycoin-development-update-week-24/)| [Week 25](https://www.skycoin.com/blog/posts/skycoin-development-update-week-25/)| [Week 26](https://www.skycoin.com/blog/posts/skycoin-development-update-week-26/)
...
read here: [https://github.com/skycoin/cx/wiki/CX-Chains-Tutorial](https://github.com/skycoin/cx/wiki/CX-Chains-Tutorial "https://github.com/skycoin/cx/wiki/CX-Chains-Tutorial").
...
* In-wallet Skycoin purchases using Bitcoin and a few other selected alts. This service is provided by [swaplab](https://www.swaplab.cc/) and makes it possible for our users to purchase Skycoin without having to register on an exchange.

The team was very happy to announce the launch of the new [Android wallet](https://play.google.com/store/apps/details?id=com.skycoin.wallet) with Japanese language support towards the end of June, followed a few days later by the [iOS version](https://itunes.apple.com/gb/app/skycoin/id1439949089?mt=8). We welcome native Japanese speakers to the Sky family. What would the land of the rising sun be without a SKY for the sun to rise into?

![Skycoin Android wallet supports Japanese](/img/Skycoin Android Wallet supports Japanese.png "Skycoin Android wallet supports Japanese")
...
![Synth and Max Brock ponder the future of Crypto](/img/Synth_and_Max_Brock.jpg "Synth and Max Brock ponder the future of Crypto")

<br>

## Cryptonimist article

[Emanuele Pagliar](https://cryptonomist.ch/en/author/emanuele-pagliari/)i of the Cryptonomist honoured Skycoin with an [in-depth piece](https://cryptonomist.ch/en/2019/06/29/what-is-skycoin-sky/) commencing with the origins of Skycoin. The piece then goes on to examine Skycoin’s many features that we all came to love. Feeless transactions, privacy and security, high scalability, and lower power consumption are among the features that are detailed. Emanuele next examines specific components, specifically Fiber, Skyminers, CX & CXO.Writing extensively on the benefits of Skywire. Over all it's a well written piece that does justice to the magnitude and scope of the Skycoin project.

<br>

## Exchange Listings

![Skycoin listed on Coinsuper](/img/Skycoin Trading on Coinsuper.png "Skycoin listed on Coinsuper")
...
Interested parties can apply here: team@skycoin.com

![Skywire rollout in New York City](/img/Skycoin New York Operation.png "Skywire rollout in New York City")![Celebrating Skywire testnet 1-year anniversary ](/img/Testnet Anniversary Article-1.jpg "Celebrating Skywire testnet 1-year anniversary ")
...
That is all from our side for June #MonthOfAnouncements but that doesn't mean the announcements are over. As always, Skycoin will keep on delivering, along side the Skyfleet as shown in the latest [Monthly Manifest article](https://medium.com/skyfleet-captains-log/skyfleet-manafest-june-2019-e29ed8b1b1e2). Stay tuned to any of our many communication channels and you won't miss any of the action.
