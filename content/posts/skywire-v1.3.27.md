...
title = "Skywire v1.3.27 Released"
+++

### Skywire v1.3.27

Skywire v1.3.27 has been released and is available from [GitHub](https://github.com/skycoin/skywire/releases/tag/v1.3.27).

- **Config gen fix** — fixed services-config.json file path for `skywire cli config gen`
