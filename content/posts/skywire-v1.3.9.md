...
title = "Skywire v1.3.9 Released"
+++

### Skywire v1.3.9

Skywire v1.3.9 has been released and is available from [GitHub](https://github.com/skycoin/skywire/releases/tag/v1.3.9).

- **Config gen fix** — fixed the `skywire-cli config gen -r` flag
