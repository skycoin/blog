...
title = "Skywire v1.3.16 Released"
+++

### Skywire v1.3.16

Skywire v1.3.16 has been released and is available from [GitHub](https://github.com/skycoin/skywire/releases/tag/v1.3.16).

- **Windows VPN fix** — resolved VPN issues on Windows
- **App stop fix** — fixed the logic for stopping applications
